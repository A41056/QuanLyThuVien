...
INSERT INTO BookTypes(Code,Name)
...
INSERT INTO Authors(Name,Birth,Address,Email,Phone)
...
INSERT INTO PublishCompanys(Name,Address,Email,Phone)
...
(
	...
	FOREIGN KEY(IDPublish) REFERENCES PublishCompanys(ID),
	FOREIGN KEY(IDAuthor) REFERENCES Authors(ID),
	FOREIGN KEY(CodeTypeBook) REFERENCES BookTypes(Code),
	FOREIGN KEY(IDInventory) REFERENCES Inventory(ID)

)
GO

INSERT INTO Books(Code,Name,IDPublish,IDAuthor,CodeTypeBook,PublishDate,IDInventory)
